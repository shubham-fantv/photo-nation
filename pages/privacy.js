    ...
    <div className="min-h-screen text-black px-4 py-12 flex justify-center">
      <div className="max-w-3xl">
        ...
        <p className="mb-6 leading-relaxed text-black">
          ...
          "legitimate interests" where processing is necessary by us to provide you with customer
          support and for processing for "performance of the contract" wherein processing is
          essential in enabling our Service to the users. We may also process your information for
          "legal requirements" and in order to comply with applicable laws and to co-ordinate with
          law enforcement agencies. The information collected from you is used by us to develop and
          improve the Service and also to provide you a personalised experience while using the
          Service. We use information to provide, analyse, administer, enhance, and personalize our
          service and marketing efforts, to process your registration, to provide you services, and
          to communicate with you related to below mentioned points. For example, we use information
          to: a. provide you our Service. b. provide certain features of our Service. c. provide you
          information about our services and products. d. provide you personalised services and
          products. e. show you personalised content recommendations. f. provide you a tailored and
          ...
          subscribe/unsubscribe (where feasible)]. We may, however, use your email address without
          further consent for non-marketing or administrative purposes such as notifying you of
          major changes, for customer service purposes, billing, notifying you in case of breach
          incidents, etc. Any personally identifiable information provided by you will not be
          considered as sensitive if it is freely available and/or accessible in the public domain
          like any comments, messages, blogs, scribbles available on social media platforms like
          Facebook, Twitter etc. Any content posted/uploaded/conveyed/communicated by users on the
          public sections of the Service becomes published content and is not considered personally
          identifiable information subject to this Privacy Policy. In case you choose to decline to
          submit personally identifiable information on the Service, we may not be able to provide
          certain services to you. We will make reasonable efforts to notify you of the same at the
          time of opening your account. In any case, we will not be liable and or responsible for
          ...
          protect the rights, property, safety, or security of third parties, comply with a court
          order, or request from governmental authority or law enforcement agencies. Public
          information on the Service can be seen by any person, including if they do not have an
          account. This includes the username, any published content on the profile, profile
          ...
          that any personal information or sensitive personal data or information found to be
          inaccurate or deficient shall be corrected or amended as feasible. We ask individual Users
          to identify themselves and the information requested to be accessed or corrected before
          processing such requests. We may decline to process requests that are unreasonably
          repetitive or systematic, requiring disproportionate technical effort, jeopardizing the
          ...
          processing practices and security measures, including appropriate encryption and physical
          security measures to guard against unauthorized access to systems where we store personal
          data. All information gathered on the Service is securely stored within our controlled
          database. The database is stored on servers secured behind a firewall; access to the
          servers is password-protected and is strictly limited. However, please note that we cannot
          assure 100% safety of any information and therefore, users must exercise discretion in
          sharing their information. If you know or have reason to believe that your Service account
          credentials have been lost, stolen, altered, or otherwise compromised or in case of any
          actual or suspected unauthorized use of your account, please contact us by contacting our
          customer support team. It is the User’s responsibility to only allow individuals to use
          your account where you're comfortable sharing this personal data with them. CHILDREN’S
          ...
          do not seek or intend to seek or receive any personal information from children. Should a
          parent or guardian have reasons to believe that a minor has provided us with personal
          information without their prior consent, please contact our customer support team to
          ensure that the personal information is removed from the Service. CHANGES TO THIS POLICY
          This Privacy Policy is subject to change from time to time. We reserve the right, at our
          sole discretion, to modify the terms of this Privacy Policy from time to time in order to
          ensure compliance with applicable laws. The updated privacy policy shall be effective
          immediately and shall supersede these the terms of this Privacy Policy. We are not under
          an obligation to notify you of any changes to this Privacy Policy except if the changes
          made to the policy significantly affects your rights or as may be required by law. You
          shall be solely responsible for reviewing the Privacy Policy from time to time for any
          modifications. By continuing to use the Service after the updated Terms have been
